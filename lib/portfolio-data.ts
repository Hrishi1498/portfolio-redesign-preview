...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: 'Once product data is complete, brands can generate multiple digital passports per product. Each passport generates a unique URL and QR code for per-unit traceability and batch-wise passport creation.',
        highlight: 'Track active passports, total quantities, and manage QR code distribution.',
        image: '/dpp-passports.png',
      },
      {
        id: 11,
        type: 'scene',
        title: 'Consumer Experience',
        content: 'When consumers scan the QR code, they instantly land on a beautiful product passport page showing detailed information including product description, material compositions, care instructions, recyclability, and circular services.',
        highlight: 'No login required - instant transparency at the point of purchase.',
        image: '/dpp-consumer.png',
      },
      {
        id: 12,
        type: 'stats',
      ...
      },
      {
        ...
        galleryImages: ['/dpp-dashboard.png', '/dpp-products.png', '/dpp-passports.png', '/dpp-consumer.png'],
      },
    ],
  },
  {
