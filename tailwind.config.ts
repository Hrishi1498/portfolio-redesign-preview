  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: ['var(--font-noto-sans-display)', 'sans-serif'],
        body: ['var(--font-noto-sans-display)', 'sans-serif'],
        editorial: ['var(--font-noto-sans-display)', 'sans-serif'],
        garamond: ['var(--font-noto-sans-display)', 'sans-serif'],
        caslon: ['var(--font-noto-sans-display)', 'sans-serif'],
      },
      fontSize: {
