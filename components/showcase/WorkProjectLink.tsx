...
function ArrowIcon() {
  return (
    <svg
      ...
      aria-hidden
      className="relative z-10 transition-transform duration-200 group-hover/link:translate-x-0.5 group-hover/link:-translate-y-0.5"
    >
      <path
...
export function WorkProjectLink({
  ...
  const className =
    'group/link relative inline-flex items-center gap-2.5 overflow-hidden rounded-full bg-zinc-950 px-7 py-3.5 font-heading text-[0.9375rem] font-medium tracking-[-0.01em] text-white transition-all duration-300 hover:scale-[1.02] hover:bg-zinc-800 sm:px-8'
